...
def inference():
    ...
    testing = "test_features.parquet"
     
    df = pl.read_parquet(testing)
    ...
    listnet = ListNetTrain()
    listnet.load_model(path=MODEL_PATH)
    listnet._get_data(df,df)
    listnet._prepare_data()
